          ...
          <Card className="mb-4">
            ...
            <Card.Body>
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  Mentor junior developers, fostering their growth in Node.js best practices, code quality, and software
                  development principles
                </ListGroup.Item>
                <ListGroup.Item>
                  Founded CodeBuddy, a Vscode generative AI coding assistant, to enhance developer productivity and code
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  Implemented a message queue (Apache Kafka) to handle high volumes of user requests and ensure reliable
                  communication between microservices, enabling real-time bidding and auction management for a seamless
                  user experience
                </ListGroup.Item>
                <ListGroup.Item>
                ...
                <ListGroup.Item>
                  Collaborated effectively with cross-functional teams, including front-end developers, UI/UX designers,
                  and product managers, fostering effective communication and alignment throughout the project lifecycle
                </ListGroup.Item>
              </ListGroup>
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  Built ticketing system alongside web development team to facilitate easy collection of event revenues
                  and ensure company realizes maximum profits in its numerous events.
                </ListGroup.Item>
                <ListGroup.Item>
